...
type QueryGetUpdatePostRequest struct {
	Id uint64 `protobuf:"varint,1,opt,name=id,proto3" json:"id,omitempty"`
}

func (m *QueryGetUpdatePostRequest) Reset()         { *m = QueryGetUpdatePostRequest{} }
func (m *QueryGetUpdatePostRequest) String() string { return proto.CompactTextString(m) }
func (*QueryGetUpdatePostRequest) ProtoMessage()    {}
func (*QueryGetUpdatePostRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_b1671705bf75f3f4, []int{14}
}
func (m *QueryGetUpdatePostRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *QueryGetUpdatePostRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_QueryGetUpdatePostRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *QueryGetUpdatePostRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_QueryGetUpdatePostRequest.Merge(m, src)
}
func (m *QueryGetUpdatePostRequest) XXX_Size() int {
	return m.Size()
}
func (m *QueryGetUpdatePostRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_QueryGetUpdatePostRequest.DiscardUnknown(m)
}

var xxx_messageInfo_QueryGetUpdatePostRequest proto.InternalMessageInfo

func (m *QueryGetUpdatePostRequest) GetId() uint64 {
	if m != nil {
		return m.Id
	}
	return 0
...
type QueryGetUpdatePostResponse struct {
	UpdatePost UpdatePost `protobuf:"bytes,1,opt,name=UpdatePost,proto3" json:"UpdatePost"`
}

func (m *QueryGetUpdatePostResponse) Reset()         { *m = QueryGetUpdatePostResponse{} }
func (m *QueryGetUpdatePostResponse) String() string { return proto.CompactTextString(m) }
func (*QueryGetUpdatePostResponse) ProtoMessage()    {}
func (*QueryGetUpdatePostResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_b1671705bf75f3f4, []int{15}
}
func (m *QueryGetUpdatePostResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *QueryGetUpdatePostResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_QueryGetUpdatePostResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *QueryGetUpdatePostResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_QueryGetUpdatePostResponse.Merge(m, src)
}
func (m *QueryGetUpdatePostResponse) XXX_Size() int {
	return m.Size()
}
func (m *QueryGetUpdatePostResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_QueryGetUpdatePostResponse.DiscardUnknown(m)
}

var xxx_messageInfo_QueryGetUpdatePostResponse proto.InternalMessageInfo

func (m *QueryGetUpdatePostResponse) GetUpdatePost() UpdatePost {
	if m != nil {
		return m.UpdatePost
	}
	return UpdatePost{}
...
type QueryAllUpdatePostRequest struct {
	Pagination *query.PageRequest `protobuf:"bytes,1,opt,name=pagination,proto3" json:"pagination,omitempty"`
}

func (m *QueryAllUpdatePostRequest) Reset()         { *m = QueryAllUpdatePostRequest{} }
func (m *QueryAllUpdatePostRequest) String() string { return proto.CompactTextString(m) }
func (*QueryAllUpdatePostRequest) ProtoMessage()    {}
func (*QueryAllUpdatePostRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_b1671705bf75f3f4, []int{16}
}
func (m *QueryAllUpdatePostRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *QueryAllUpdatePostRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_QueryAllUpdatePostRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *QueryAllUpdatePostRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_QueryAllUpdatePostRequest.Merge(m, src)
}
func (m *QueryAllUpdatePostRequest) XXX_Size() int {
	return m.Size()
}
func (m *QueryAllUpdatePostRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_QueryAllUpdatePostRequest.DiscardUnknown(m)
}

var xxx_messageInfo_QueryAllUpdatePostRequest proto.InternalMessageInfo

func (m *QueryAllUpdatePostRequest) GetPagination() *query.PageRequest {
	if m != nil {
		return m.Pagination
	}
	return nil
...
type QueryAllUpdatePostResponse struct {
	UpdatePost []UpdatePost        `protobuf:"bytes,1,rep,name=UpdatePost,proto3" json:"UpdatePost"`
	Pagination *query.PageResponse `protobuf:"bytes,2,opt,name=pagination,proto3" json:"pagination,omitempty"`
}

func (m *QueryAllUpdatePostResponse) Reset()         { *m = QueryAllUpdatePostResponse{} }
func (m *QueryAllUpdatePostResponse) String() string { return proto.CompactTextString(m) }
func (*QueryAllUpdatePostResponse) ProtoMessage()    {}
func (*QueryAllUpdatePostResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_b1671705bf75f3f4, []int{17}
}
func (m *QueryAllUpdatePostResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *QueryAllUpdatePostResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_QueryAllUpdatePostResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *QueryAllUpdatePostResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_QueryAllUpdatePostResponse.Merge(m, src)
}
func (m *QueryAllUpdatePostResponse) XXX_Size() int {
	return m.Size()
}
func (m *QueryAllUpdatePostResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_QueryAllUpdatePostResponse.DiscardUnknown(m)
}

var xxx_messageInfo_QueryAllUpdatePostResponse proto.InternalMessageInfo

func (m *QueryAllUpdatePostResponse) GetUpdatePost() []UpdatePost {
	if m != nil {
		return m.UpdatePost
	}
	return nil
...
func (m *QueryAllUpdatePostResponse) GetPagination() *query.PageResponse {
	if m != nil {
		return m.Pagination
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*QueryGetUpdatePostRequest)(nil), "planet.blog.QueryGetUpdatePostRequest")
	proto.RegisterType((*QueryGetUpdatePostResponse)(nil), "planet.blog.QueryGetUpdatePostResponse")
	proto.RegisterType((*QueryAllUpdatePostRequest)(nil), "planet.blog.QueryAllUpdatePostRequest")
	proto.RegisterType((*QueryAllUpdatePostResponse)(nil), "planet.blog.QueryAllUpdatePostResponse")
}
...
var fileDescriptor_b1671705bf75f3f4 = []byte{
	...
	,
}
...
type QueryClient interface {
	...
	// Queries a list of UpdatePost items.
	UpdatePost(ctx context.Context, in *QueryGetUpdatePostRequest, opts ...grpc.CallOption) (*QueryGetUpdatePostResponse, error)
	UpdatePostAll(ctx context.Context, in *QueryAllUpdatePostRequest, opts ...grpc.CallOption) (*QueryAllUpdatePostResponse, error)
}
...
func (c *queryClient) UpdatePost(ctx context.Context, in *QueryGetUpdatePostRequest, opts ...grpc.CallOption) (*QueryGetUpdatePostResponse, error) {
	out := new(QueryGetUpdatePostResponse)
	err := c.cc.Invoke(ctx, "/planet.blog.Query/UpdatePost", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) UpdatePostAll(ctx context.Context, in *QueryAllUpdatePostRequest, opts ...grpc.CallOption) (*QueryAllUpdatePostResponse, error) {
	out := new(QueryAllUpdatePostResponse)
	err := c.cc.Invoke(ctx, "/planet.blog.Query/UpdatePostAll", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type QueryServer interface {
	...
	// Queries a list of UpdatePost items.
	UpdatePost(context.Context, *QueryGetUpdatePostRequest) (*QueryGetUpdatePostResponse, error)
	UpdatePostAll(context.Context, *QueryAllUpdatePostRequest) (*QueryAllUpdatePostResponse, error)
}
...
func (*UnimplementedQueryServer) UpdatePost(ctx context.Context, req *QueryGetUpdatePostRequest) (*QueryGetUpdatePostResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdatePost not implemented")
}
func (*UnimplementedQueryServer) UpdatePostAll(ctx context.Context, req *QueryAllUpdatePostRequest) (*QueryAllUpdatePostResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdatePostAll not implemented")
}
...
func _Query_UpdatePost_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(QueryGetUpdatePostRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(QueryServer).UpdatePost(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/planet.blog.Query/UpdatePost",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(QueryServer).UpdatePost(ctx, req.(*QueryGetUpdatePostRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Query_UpdatePostAll_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(QueryAllUpdatePostRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(QueryServer).UpdatePostAll(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/planet.blog.Query/UpdatePostAll",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(QueryServer).UpdatePostAll(ctx, req.(*QueryAllUpdatePostRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Query_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Query_UpdatePost_Handler,
		},
		{
			MethodName: "UpdatePostAll",
			Handler:    _Query_UpdatePostAll_Handler,
		},
	},
...
func (m *QueryGetUpdatePostRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *QueryGetUpdatePostRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *QueryGetUpdatePostRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *QueryGetUpdatePostResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *QueryGetUpdatePostResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *QueryGetUpdatePostResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	{
		size, err := m.UpdatePost.MarshalToSizedBuffer(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *QueryAllUpdatePostRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *QueryAllUpdatePostRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *QueryAllUpdatePostRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *QueryAllUpdatePostResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *QueryAllUpdatePostResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *QueryAllUpdatePostResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if len(m.UpdatePost) > 0 {
		for iNdEx := len(m.UpdatePost) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.UpdatePost[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *QueryGetUpdatePostRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *QueryGetUpdatePostResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *QueryAllUpdatePostRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *QueryAllUpdatePostResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *QueryGetUpdatePostRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QueryGetUpdatePostRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QueryGetUpdatePostRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
func (m *QueryGetUpdatePostResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QueryGetUpdatePostResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QueryGetUpdatePostResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field UpdatePost", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.UpdatePost.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *QueryAllUpdatePostRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QueryAllUpdatePostRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QueryAllUpdatePostRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *QueryAllUpdatePostResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QueryAllUpdatePostResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QueryAllUpdatePostResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			m.UpdatePost = append(m.UpdatePost, UpdatePost{})
			if err := m.UpdatePost[len(m.UpdatePost)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 2:
